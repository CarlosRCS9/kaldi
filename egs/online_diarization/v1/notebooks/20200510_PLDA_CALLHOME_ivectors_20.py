...
def tracking_tester(recordings_segments,
    ...
    dcf_scores = ''
    dcf_trials = ''
    for i, recording_id in enumerate(recordings_ids[:3]):
...
for vector in ['ivectors']:
    ...
    for models_generation_length in [10]:
        for i in range(1):
            ...
            test_id = '20200510_plda_callhome_' + vector + '_' + str(models_generation_length) + '_' + str(i)
