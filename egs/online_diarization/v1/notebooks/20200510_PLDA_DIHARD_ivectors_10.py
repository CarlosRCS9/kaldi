...
def tracking_tester(recordings_segments,
    ...
    groundtruth_rttm = ''.join([line for line in file.readlines() if (line.split(' ')[1] in recordings_ids) and \
                    (line.split(' ')[7] in recordings_speakers_ids[line.split(' ')[1]])])
    file.close()
...
a_directory = '../exp/augmented5/dihard_2019_dev/json'
a_groundtruth = '../exp/augmented5/dihard_2019_dev/segments_augmented_1.0_0.5_ABZ.rttm'
a_plda = '../exp/plda/dihard_2019_dev/ivectors.plda'
b_directory = '../exp/augmented5/dihard_2019_eval/json'
b_groundtruth = '../exp/augmented5/dihard_2019_eval/segments_augmented_1.0_0.5_ABZ.rttm'
...
for vector in ['ivectors']:
    ...
    for models_generation_length in [10]:
        for i in range(1):
            ...
            test_id = '20200510_plda_dihard_' + vector + '_' + str(models_generation_length) + '_' + str(i)
