...
if [ $# -lt 3 ]; then
  echo "Usage: $0 <mode> <path-to-rtve_2018_dev2> <path-to-output> <speaker-overlap> <speaker-rename>"
  echo " e.g.: $0 eval /export/corpora5/RTVE/RTVE2018DB/dev2 data/rtve_2018_dev2 true false"
  exit 1
fi
