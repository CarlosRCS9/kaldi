...
if [ $stage -le 2 ]; then
  ...
  python3 scripts/sort_segments.py $srcdir/segments --labels=$dir/labels
  mv $srcdir/segments $srcdir/segments.backup
  mv $srcdir/segments_tmp $srcdir/segments
  mv $dir/labels $dir/labels.backup
  mv $dir/labels_tmp $dir/labels
