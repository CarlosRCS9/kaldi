...
mfcc_conf=conf/mfcc_xvectors_dihard.conf
extractor_dim=512
extractor_model=/export/b01/leibny/kaldi/kaldi-dihard2-2020-01/kaldi-dihard2/egs/dihard2/v2/exp/xvector_nnet_1a
plda_a=/export/b01/leibny/kaldi/kaldi-dihard2-2020-01/kaldi-dihard2/egs/dihard2/v2/exp/xvector_nnet_1a/xvectors_dihard_2019_dev
plda_b=/export/b01/leibny/kaldi/kaldi-dihard2-2020-01/kaldi-dihard2/egs/dihard2/v2/exp/xvector_nnet_1a/xvectors_dihard_2019_dev
...
if [ $stage -le 6 ]; then
  ...
  $folder2/exp/make_xvectors/plda_scores/rttm | sed --expression='s/ 0 / 1 /g' \
    | md-eval.pl -r \
...
if [ $stage -le 7 ]; then
  ...
  $folder2/exp/make_xvectors/plda_scores_num_spk/rttm | sed --expression='s/ 0 / 1 /g' \
